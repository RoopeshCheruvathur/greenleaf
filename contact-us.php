...
?>
  ...
  <p id="info-message" class="alert alert-success text-center" > 
         <span class="" >
        <a href="#" class="close" data-dismiss="alert">&times;</a><img width="40" src="" >
        <strong> Your message has been sent.We'll revert back shortly...</strong>
        </span>
    </p>
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="contact_ins.php">
