<?php require("inc/functions.php"); ?><?php include "connection/config.php";
		...
		<div class="header_top"><!--header_top-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-10">
						<div class="shop-menu pull-right" id="basketTitleWrap">
							<ul class="nav navbar-nav">
								
								<li ><a href="cart.php" id="output" ><i class="fa fa-crosshairs"></i> Checkout</a></li>
				...
				<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo "id="productImageWrapID_'.$row[0].'" >
					   ...
					   <div class="cart-left">
						...
						<div class="cart-right"><a href="inc/functions.php?action=addToBasket&productID='.$row[0].'" onClick="return false;"> <img src="images/cart2.png" alt=""id="featuredProduct_'.$row[0].'" /></a></div>
						<div class="clear"></div>
					 </div>
					</div>
					</div>
